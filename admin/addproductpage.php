                ...
                <div class="col-lg-6">
                    <form role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input multiple="multiple" type="file" name="multifiles[]" id="multifile" accept="image/*">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="10" placeholder="Main Description" name="longDesc" id="longDesc"></textarea>
                        </div>
